...
import TreesFormPage from "./Pages/TreesFormPage/TreesFormPage.jsx";
    ...
    return (
        <>
            ...
            <Routes>
                ...
                <Route path="/trees/create" element={<TreesFormPage/>}/>
                <Route path="/trees/:id/edit" element={<TreesFormPage/>}/>
            </Routes>
        </>
    )
}
