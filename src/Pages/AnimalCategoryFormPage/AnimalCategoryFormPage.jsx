    ...
    const onFormSubmitHandler = async (e) => {
        ...
        if (id) {
            await axios.patch(`/categories/${id}`, {
                ...
                .then((res) => {
                    navigate(`/animals/categories`, {state: {message: {success: `${res.data.name} edited successfully!`}}});
                })
        } else {
            await axios.post('/categories', {
                ...
                .then((res) => {
                    navigate(`/animals/categories`, {state: {message: {success: `${res.data.name} created successfully!`}}});
                })
        }
    }
    return (
